...
public class DeleteFromFriendsCommandHandler
    : IRequestHandler<DeleteFromFriends.DeleteFromFriendsCommand, Result>
{
    ...
    public async Task<Result> Handle(DeleteFromFriends.DeleteFromFriendsCommand request, CancellationToken cancellationToken)
    {
